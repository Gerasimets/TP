                ...
                else
                {
                    ...
                    for (int i = 0; i < K; i++) // идем по каждой матрице
                    {
                        ...
                        for (int j = 0; j < N; j++)
                        {
                            for (int k = 0; k < M; k++)
                            {
                                if (mas_max_cnt[i][j][k] == 1 && zero != 1) // если по данному адресу в массиве лежит единица и при том мы знаем что ноль в кучке не один
                                {
                                ...
                                else if (array[i][j][k] == 0) // если текущий элемент 0
                                {
                                    HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
